...
/*
 ...
 | 
 */
// defined('SYSTEM_TITLE')        OR define('SYSTEM_TITLE','some apps');
defined('APPLICATION_DIRECTORY')                OR define('APPLICATION_DIRECTORY','qrvisit');
defined('APPLICATION_NAME')                     OR define('APPLICATION_NAME','qrvisit');
defined('APPLICATION_SHORTNAME')                OR define('APPLICATION_SHORTNAME','qrv');
defined('APPLICATION_AUTHOR')                   OR define('APPLICATION_AUTHOR','Farouq Zakwan Bin Zulkifli');
