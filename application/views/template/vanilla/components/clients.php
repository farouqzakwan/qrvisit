...
<div id="clients" class="section-padding">
    ...
    <div class="row text-align-">
        ...
        <div class="client-item-wrapper">
            <img class="img-fluid" src="<?php echo template_url('vanilla','assets/img/clients/img1.png'); ?>" alt="">
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.6s">
        <div class="client-item-wrapper">
            <img class="img-fluid" src="<?php echo template_url('vanilla','assets/img/clients/img2.png'); ?>" alt="">
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.9s">
        <div class="client-item-wrapper">
            <img class="img-fluid" src="<?php echo template_url('vanilla','assets/img/clients/img3.png'); ?>" alt="">
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="1.2s">
        <div class="client-item-wrapper">
            <img class="img-fluid"  src="<?php echo template_url('vanilla','assets/img/clients/img4.png'); ?>" alt="">
        </div>
        </div>
    </div>
    </div>
