    ...
    <div class="row justify-content-center">
        ...
        <div id="testimonials" class="owl-carousel wow fadeInUp" data-wow-delay="1.2s">
            ...
            <div class="testimonial-item">
                ...
                <div class="img-thumb">
                <img src="<?php echo template_url('vanilla','assets/img/testimonial/img1.jpg'); ?>" alt="">
                </div>
                <div class="info">
            ...
            <div class="testimonial-item">
                ...
                <div class="img-thumb">
                <img src="<?php echo template_url('vanilla','assets/img/testimonial/img2.jpg'); ?>" alt="">
                </div>
                <div class="info">
            ...
            <div class="testimonial-item">
                ...
                <div class="img-thumb">
                <img src="<?php echo template_url('vanilla','assets/img/testimonial/img3.jpg'); ?>" alt="">
                </div>
                <div class="info">
            ...
            <div class="testimonial-item">
                ...
                <div class="img-thumb">
                <img src="<?php echo template_url('vanilla','assets/img/testimonial/img4.png'); ?>" alt="">
                </div>
                <div class="info">
            ...
            <div class="testimonial-item">
                ...
                <div class="img-thumb">
                <img src="<?php echo template_url('vanilla','assets/img/testimonial/img5.png'); ?>" alt="">
                </div>
                <div class="info">
